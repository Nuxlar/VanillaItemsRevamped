...
namespace VanillaItemsRevamped
{
    public static class ConfigFiles
    {
        ...
        private const string uncommonString = "Items - Green";
        private const string commonString = "Items - White";
        private const string legendaryString = "Items - Red";
        ...
        private static void RiskOfOptionsCompat()
        {
            ...
            if (SurvivorsCore.enabled)
            {
                ...
                {
                    ModSettingsManager.AddOption(new RiskOfOptions.Options.CheckBoxOption(EntityStates.VanillaItemsRevamped.Captain.FireShotgun.scalePellets));
                }
        ...
        {
            GeneralCfg = new ConfigFile(System.IO.Path.Combine(ConfigFolderPath, $"VanillaItemsRevamped_General.cfg"), true);
            ...
            //Game Mechanics
            VanillaItemsRevamped.disableProcChains = GeneralCfg.Bind(gameMechString, "Disable Proc Chains", true, "Remove the proc coefficient on most item effects.").Value;
        ...
        {
            ItemCfg = new ConfigFile(System.IO.Path.Combine(ConfigFolderPath, $"VanillaItemsRevamped_Items.cfg"), true);
            ConfigCommonItems();
            ConfigUncommonItems();
        ...
        {
            SurvivorCfg = new ConfigFile(System.IO.Path.Combine(ConfigFolderPath, $"VanillaItemsRevamped_Survivors.cfg"), true);
            ...
            EntityStates.VanillaItemsRevamped.Captain.FireShotgun.scalePellets = SurvivorCfg.Bind(captainString, "Enable Primary Skill Changes - Scale Pellets with Attackspeed", true, "Vulcan Shotgun gains extra pellets with attack speed.");
            EntityStates.VanillaItemsRevamped.Captain.FireShotgun.scalePellets.SettingChanged += CaptainCore.ScalePellets_SettingChanged;
        ...
        {
            MonsterCfg = new ConfigFile(System.IO.Path.Combine(ConfigFolderPath, $"VanillaItemsRevamped_Monsters.cfg"), true);
        ...
        {
            SpawnpoolCfg = new ConfigFile(System.IO.Path.Combine(ConfigFolderPath, $"VanillaItemsRevamped_Spawnpools.cfg"), true);
